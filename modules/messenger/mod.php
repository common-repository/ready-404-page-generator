<?php
class messengerFhf extends moduleFhf {
   ...
   /* public function getTabs(){
        $tabs = array();
        $tab = new tabFhf(__('Notifications'), $this->getCode());
	...
	public function send($to, $fromName, $fromEmail, $module, $template, $variables) {
		...
		$template = frameFhf::_()->getModule('messenger')->getModel('email_templates')->getTemplate($module, $template);
       ...
       // $result = wp_mail($to, $subject, $message, $headers);
		...
		$result = frameFhf::_()->getModule('mail')->send($to, $subject, $message, $fromName, $fromEmail);
